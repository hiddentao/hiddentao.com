...
The second problem was occurring due to the fact that in order to mine, Geth first needs to build a [DAG](https://en.wikipedia.org/wiki/Directed_acyclic_graph) for the [Ethash](https://web.archive.org/web/20250511140736/https://github.com/ethereum/wiki/wiki/Ethash) algorithm to work. This is a one-time thing and takes a number of minutes to do - only after this is done can mining begin.
...
This actually took 
longer to solve. I tried using `SIGKILL`, tried using the [terminate](https://web.archive.org/web/20250426183808/https://www.npmjs.com/package/terminate) module, and tried a whole bunch of other tricks. In the end what fixed it for me was changing how I was launching the `geth` child process in the first place.
