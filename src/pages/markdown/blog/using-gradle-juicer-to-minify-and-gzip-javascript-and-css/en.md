...
If you're using [nginx](http://nginx.org/) or [Apache](http://httpd.apache.org/) to serve up the CSS and Javascript files then you can configure them to serve up GZipped versions of these resources if available. I'm using nginx and it has a [module which does this](https://web.archive.org/web/20150910091227/http://wiki.nginx.org/NginxHttpGzipStaticModule). Here are the settings I use:
