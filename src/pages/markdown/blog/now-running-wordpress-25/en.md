...
All in all the upgrade went smoothly except for one thing: the [Admin-SSL plugin](http://haris.tv/2007/04/24/admin-ssl-new-wordpress-plugin/ "Admin-SSL plugin homepage") doesn't work in Wordpess 2.5\. And I'm [not the](http://wordpress.org/support/topic/164257) [only one](no-longer-valid) who has noticed this. I consider this plugin to be a necessity (it's good to be anal about security!). I might have a crack at fixing this problem myself.

__Update (April 6th):__ Looks like I won't need to fix Admin-SSL myself. Grab the fix from [Ben Green](no-longer-valid "Admin-SSL fix").
